...
const CarouselComponent = () => {
  ...
  return (
    <>
      <div className="relative w-full h-[600px] md:h-[530px] z-0 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row md:px-4 md:pb-10 py-3 lg:py-8">
              <div className="flex flex-col  md:px-4 md:pb-10 py-3 lg:py-8">
                ...
                <form
                  ...
                  className="flex flex-col md:gap-y-2.5 relative animate-fadeIn"
                >
              ...
              <div className="animate-fadeIn w-full pb-8 lg:w-1/2  lg:px-8 py-4 lg:border-l lg:border-l-gray-500 flex flex-col items-start space-y-4">
                <Link to="/contact">
                ...
                <div className="flex items-center cursor-pointer">
                  <ul className="list-none space-y-3 lg:pl-2">
                    <li className="text-green font-bold">
                      <strong className="text-4xl text-gray-200 font-bold ">
                        100+
                      </strong>{" "}
                      COMPLETED PROJECTS
                    </li>
